/*****************************************************************************
* Filename:          D:\Sanket\PSU_LECT\Embedded_with_FPGA\Xilinx_Projects\project2/drivers/hardware_pwm_detect_v1_00_a/src/hardware_pwm_detect_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the hardware_pwm_detect driver
...
XStatus HARDWARE_PWM_DETECT_SelfTest(void * baseaddr_p)
{
  ...
  HARDWARE_PWM_DETECT_mReset(baseaddr);
  ...
  HARDWARE_PWM_DETECT_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = HARDWARE_PWM_DETECT_mReadSlaveReg0(baseaddr, 0);
  ...
  HARDWARE_PWM_DETECT_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = HARDWARE_PWM_DETECT_mReadSlaveReg1(baseaddr, 0);
